...
- Round-trips the text through one randomly chosen language and back to English (Workers AI, `@cf/meta/llama-3.1-8b-instruct-fp8`), then shows a word-level diff of what changed and the Neurons it cost against the free plan's 10,000/day.
